<?php
// --- Inicio Autenticación Básica PHP ---
date_default_timezone_set('America/Argentina/Buenos_Aires'); // Set timezone to Buenos Aires
$usuario_esperado = 'admin';
$contrasena_esperada = date('Ymd'); // Contraseña es la fecha actual YYYYMMDD
...
<body class="p-3" style="background-color: #66615b;">
    ...
    <div class="container p-1 shadow-lg" style="max-width: 900px; background: #66615b">
        ...
        <form autocomplete=off class="p-4 bg-light" id="form" method="POST" action="index.php">
            ...
            <div class="row my-3">
                ...
                <div class="col-sm-6 col-12">
                    ...
                    <div class="form-floating mb-1">
                        <!-- Grupo -->
                        <input autocomplete="off" type="text" class="form-control" id="api_url" name="api_url"
                            placeholder="URL API" autocomplete=off> <!-- Campo -->
                ...
                <div class="col-sm-3 col-12">
                    ...
                    <div class="form-floating mb-1">
                        <!-- Grupo -->
                        <input autocomplete="off" type="text" class="form-control req" id="api_user" name="api_user"
                            placeholder="Usuario API" autocomplete=off> <!-- Campo -->
                ...
                <div class="col-sm-3 col-12">
                    ...
                    <div class="form-floating mb-1">
                        <!-- Grupo -->
                        <input autocomplete="off" type="password" class="form-control req" id="api_pass" name="api_pass"
                            placeholder="Password API" autocomplete=off> <!-- Campo -->
            ...
            <div class="row mb-1">
                ...
                <div class="col-sm-3 col-12">
                    ...
                    <div class="form-floating mb-1">
                        <!-- Grupo -->
                        <input autocomplete="off" type="text" class="form-control req" id="mssql_srv"
                            placeholder="mssql_srvHelp" name="mssql_srv" autocomplete=off> <!-- Campo -->
                ...
                <div class="col-sm-3 col-12">
                    ...
                    <div class="form-floating mb-1">
                        <!-- Grupo -->
                        <input autocomplete="off" type="text" class="form-control req" id="mssql_db" name="mssql_db"
                            placeholder="mssql_dbHelp" autocomplete=off> <!-- Campo -->
                ...
                <div class="col-sm-3 col-12">
                    ...
                    <div class="form-floating mb-1">
                        <!-- Grupo -->
                        <input autocomplete="off" type="text" class="form-control req" id="mssql_user" name="mssql_user"
                            placeholder="mssql_userHelp" autocomplete=off> <!-- Campo -->
                ...
                <div class="col-sm-3 col-12">
                    ...
                    <div class="form-floating mb-1">
                        <!-- Grupo -->
                        <input autocomplete="off" type="password" class="form-control req" id="mssql_pass"
                            name="mssql_pass" placeholder="mssql_passHelp" autocomplete=off> <!-- Campo -->
            ...
            <div class="row mb-1">
                ...
                <div class="col-sm-6 col-12">
                    ...
                    <div class="form-floating mb-1">
                        <!-- Grupo -->
                        <input autocomplete="off" type="text" class="form-control req" id="ws_ip"
                            placeholder="ws_ipHelp" name="ws_ip" autocomplete=off
                            placeholder="http://localhost:6400/RRHHWebService/"> <!-- Campo -->
            ...
            <div class="row mb-1">
                ...
                <div class="col-sm-3 col-12">
                    ...
                    <div class="form-floating mb-1">
                        <!-- Grupo -->
                        <input autocomplete="off" type="text" class="form-control" id="proxy_ip"
                            placeholder="proxy_ipHelp" name="proxy_ip" autocomplete=off> <!-- Campo -->
                ...
                <div class="col-sm-3 col-12">
                    ...
                    <div class="form-floating mb-1">
                        <!-- Grupo -->
                        <input autocomplete="off" type="text" class="form-control" id="proxy_puerto"
                            placeholder="proxy_puertoHelp" name="proxy_puerto" autocomplete=off> <!-- Campo -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-check form-switch mt-2">
                                <!-- Grupo -->
                                <input class="form-check-input" type="checkbox" name="logs_conn_success"
                                    id="logs_conn_success"> <!-- Campo -->
                                <label class="form-check-label" for="logs_conn_success">Exitosa </label>
                                <!-- Etiqueta -->
                            </div> <!-- /Grupo -->
                            <div class="form-check form-switch mt-2">
                                <!-- Grupo -->
                                <input class="form-check-input" type="checkbox" name="logs_conn_error"
                                    id="logs_conn_error" checked> <!-- Campo -->
                ...
                <div class="col-sm-6 col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-check form-switch mt-2">
                                <!-- Grupo -->
                                <input class="form-check-input" type="checkbox" name="logs_nov_success"
                                    id="logs_nov_success" checked> <!-- Campo -->
                                <label class="form-check-label" for="logs_nov_success">Ingresadas </label>
                                <!-- Etiqueta -->
                            </div> <!-- /Grupo -->
                            <div class="form-check form-switch mt-2">
                                <!-- Grupo -->
                                <input class="form-check-input" type="checkbox" name="logs_nov_error"
                                    id="logs_nov_error" checked>
                                <label class="form-check-label" for="logs_nov_error"> No Ingresadas</label>
                                <!-- Etiqueta -->
                            </div> <!-- /Grupo -->
                        </div> <!-- /Columna -->
                    </div> <!-- /Fila -->
            ...
            <div class="row mb-1 d-none">
                ...
                <div class="col-12">
                    ...
                    <div class="form-check form-switch mt-2">
                        <!-- Grupo -->
                        <input class="form-check-input" type="checkbox" name="interrumpirCarga" id="interrumpirCarga">
                        <!-- Campo -->
                        <label class="form-check-label" for="interrumpirCarga">Para Ingresos</label> <!-- Etiqueta -->
                    </div> <!-- /Grupo -->
                    <div class="form-check form-switch mt-2">
                        <!-- Grupo -->
                        <input class="form-check-input" type="checkbox" name="interrumpirAnluacion"
                            id="interrumpirAnluacion">
                        <label class="form-check-label" for="interrumpirAnluacion"> Para Anulaciones</label>
                        <!-- Etiqueta -->
                    </div> <!-- /Grupo -->
                </div> <!-- /Columna -->
            </div> <!-- /Fila -->
            <div class="row mb-1">
                ...
                <div class="col-12">
                    ...
                    <div class="d-inline-flex">
                        ...
                        <div class="form-check form-switch mt-2">
                            <!-- Grupo -->
                            <input class="form-check-input" type="checkbox" name="logs_borrar_estado"
                                id="logs_borrar_estado" checked> <!-- Campo -->
                            <label class="form-check-label" for="logs_borrar_estado"></label> <!-- Etiqueta -->
                        </div> <!-- /Grupo -->
                        <div class="form-text mt-2">Cada</div> <!-- Etiqueta -->
                        <input autocomplete="off" type="number" class="form-control ms-2" id="logs_borrar_dias"
                            aria-describedby="logs_borrar_diasHelp" name="logs_borrar_dias" autocomplete=off min="1"
                            max="365" style="width: 70px;"> <!-- Campo -->
            ...
            <div class="row mt-4">
                <div class="col-12">
                    ...
                    <button class="btn btn-secondary" type="button" data-bs-toggle="offcanvas"
                        data-bs-target="#offcanvasLogs" aria-controls="offcanvasLogs" id="verLogs" hidden>
                        Log
                    </button>
        ...
        <div class="offcanvas offcanvas-top h-100" tabindex="-1" id="offcanvasLogs" aria-labelledby="offcanvasLogsLabel"
            style="background-color: #2D333B;color: #ADB6BA">
            <!-- Inicio Offcanvas -->
            <div class="offcanvas-header">
                <!-- Inicio Offcanvas Header -->
                <h5 class="offcanvas-title" id="offcanvasLogsLabel">Log</h5> <!-- Título -->
                <button type="button" class="bg-white btn-close text-reset" data-bs-dismiss="offcanvas"
                    aria-label="Close"></button> <!-- Botón Cerrar -->
